#include<bits/stdc++.h>
using namespace std;
void push1(int x, vector<int> &nums, int &top1, int &top2) {
    if(top1 <= top2) {
        nums[top1] = x;
        top1++;
    }
...
void push2(int x,vector<int> &nums,int &top1, int &top2) {
    if(top1 <= top2) {
        nums[top2] = x;
        top2--;
    }
